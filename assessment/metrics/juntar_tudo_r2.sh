...
problem=$1
	rm -f "results/all-$problem-r2.txt"
	...
	#for objectives in 2 3 5 8 9; do
		...
		java -Xmx1G -cp ../assessment/metrics/ r2 $comando >> "results/all-$problem-r2.txt"

		unset comando;
		echo $EFS >> "results/all-$problem-r2.txt"
		echo $EFS >> "results/all-$problem-r2.txt"
		echo $EFS >> "results/all-$problem-r2.txt"
		echo $EFS >> "results/all-$problem-r2.txt"
		echo $EFS >> "results/all-$problem-r2.txt"
