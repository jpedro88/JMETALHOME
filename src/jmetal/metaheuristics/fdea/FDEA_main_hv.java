...
//	for(int fun=0;fun<=9;fun++){
        ...
        selection = SelectionFactory.getSelectionOperator("HyperVolume",
                parameters);
...
//        population.printObjectivesToFile("VAR0");
        population.printObjectivesToFile("VAR0HV");
...
//        population.printVariablesToFile("FUN0");
        population.printVariablesToFile("FUN0HV");
