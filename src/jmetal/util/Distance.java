...
// 	   front.get(n).setCrowdingDistance(front.get(n).getCrowdingDistance()/10);
...
public void crowdingDistanceAssignment44(SolutionSet solutionSet, int nObjs) {
    int size = solutionSet.size();        
...
public void crowdingDistanceAssignment4(SolutionSet solutionSet, int nObjs) {
    int size = solutionSet.size();        
...
public void crowdingDistanceAssignment45(SolutionSet solutionSet, int nObjs) {
    int size = solutionSet.size();        
...
public void crowdingDistanceAssignment46(SolutionSet solutionSet, int nObjs) {
    int size = solutionSet.size();        
...
public void crowdingDistanceAssignment54(SolutionSet solutionSet, int nObjs) {
    int size = solutionSet.size();        
...
public void crowdingDistanceAssignment55(SolutionSet solutionSet, int nObjs) {
    int size = solutionSet.size();        
  ...
  /*for (int i = 0; i<nObjs; i++) { 
	  ...
	  objectiveMin[i] = front.get(0).getNormalizedObjective(i);
      objectiveMax[i] = front.get(front.size()-1).getNormalizedObjective(i);
      for (int j = 1; j < size-1; j++) {
...
public void crowdingDistanceAssignment77(SolutionSet solutionSet, int nObjs) {
    int size = solutionSet.size();
